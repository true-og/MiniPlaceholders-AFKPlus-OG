...
dependencies {
    ...
    compileOnly("net.lapismc:AFKPlus:3.4.5") // Import AFKPlus dependency.

    implementation("org.ocpsoft.prettytime:prettytime:5.0.8.Final") // Import PrettyTime dependency.
