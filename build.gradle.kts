...
/* ----------------------------- Metadata ------------------------------ */
group = "net.lapismc" // Declare bundle identifier.
...
repositories {
    ...
    maven { url = uri("https://maven.lapismc.net/repository/maven/") } // Import the LapisMC Maven Repository.
    maven { url = uri("https://oss.sonatype.org/content/groups/public/") } // Import the OSS Sonatype Maven Repository.
}
